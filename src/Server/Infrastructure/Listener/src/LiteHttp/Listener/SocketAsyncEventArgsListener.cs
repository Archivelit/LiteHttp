...
public sealed class SocketAsyncEventArgsListener : IDisposable
{
    ...
    public SocketAsyncEventArgsListener(ILogger<Listener>? logger = null)
    {
    ...
    public SocketAsyncEventArgsListener(IPAddress address)
        : this(address, AddressConstants.DEFAULT_SERVER_PORT) { }

    public SocketAsyncEventArgsListener(IPEndPoint endPoint, ILogger<Listener>? logger = null)
    {
        if (logger is not null)
            _logger = logger;
    ...
    public SocketAsyncEventArgsListener(IPAddress address, int port = AddressConstants.DEFAULT_SERVER_PORT, ILogger<Listener>? logger = null)
    {
        if (logger is not null)
            _logger = logger;
